...
class Calendar {  
    ...
    /**
    * Affiche le calandrier
    */
    public function show() {
        $year  = null;
         
        $month = null;
         //Si l'année est null et que l'année de l'URL n'est pas null, Get l'année sinon prend l'année par la variable date
        ...
        //Si le mois est null et que le mois de l'URL n'est pas null, Get le mois sinon prend le mois par la variable date
    ...
    */
    private function _showDay($cellNumber){
        ...
        //Si le jours actuel est = à 0 mettre la journée à 1
